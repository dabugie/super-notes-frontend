...
export const Signin = () => {
  ...
  return (
    <div className="container relative md:h-auto lg:h-full flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      <Link to="/signup" className={cn(buttonVariants({ variant: 'ghost' }), 'absolute right-8 top-8')}>
        {t('sign-up')}
      </Link>
      ...
      <div className="relative hidden h-screen flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <div className="relative z-20 flex items-center text-lg font-medium">SuperNotes</div>
      ...
      <div className="h-screen flex items-center">
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px] ">
          <div className="flex flex-col space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground">{t('sign-in-desc')}</p>
          </div>
